...
def test_bedrock_embeddings():
    ...
    print(f"   Auth Method: EC2 IAM Role (automatic)")
    ...
    try:
        ...
        if "credentials" in error_msg or "unauthorized" in error_msg or "access denied" in error_msg:
