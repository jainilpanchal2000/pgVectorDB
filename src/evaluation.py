...
def print_detailed_results(
    ...
    for i, (query, retrieved, relevant) in enumerate(zip(queries, retrieved_results, ground_truth), 1):
        ...
        print(f"  AP: {metrics['average_precision']:.3f} | RR: {metrics['reciprocal_rank']:.3f} | NDCG: {metrics['ndcg']:.3f}")
...
if __name__ == "__main__":
    ...
    if result.precision < 0.5:
        ...
        print("   → Consider: Stricter filtering, better embeddings, or tuning similarity threshold")
...
"""
    ...
    def export_results(self, filepath: str) -> None:
        ...
        data = {
            ...
            'results': {
                k: result.to_dict()
                for k, result in self.results_by_k.items()
            },
